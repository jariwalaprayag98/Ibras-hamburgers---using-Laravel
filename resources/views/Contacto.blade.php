...
<body bgcolor="black" text="white">
    ...
    <ul>
            ...
            <li><a href="http://localhost:8000/Contacto"><font color='red'>CONTACTO</font></a></li>
            <?php
                if(isset($_SESSION['userid'])){
	...
	<div class="back1-image">
		...
		<div>
          ...
          @csrf
					<div>
						<input type="text" name="name" placeholder="  Name" class="t2" required><br>
						<input type="email" name="e-mail" placeholder="  E-mail" class="t2" pattern="^([a-zA-Z0-9_\-\.]+)@([a-zA-Z0-9_\-\.]+)\.([a-zA-Z]{2,5})$" title="email is not in a correct format" required><br>
						<input type="text" name="subject" placeholder="  Subject" class="t2" required><br>
						<textarea rows="8" name="Msg" placeholder="Message" class="t2" required></textarea><br><br>
