    ...
    <br><br>
      <center>
        @foreach($hamburgers as $hamburgers)
          <form method='post' action="/place_order" id='myForm'>
            @csrf
            <?php
            if(isset($_SESSION['userid'])){
            ...
            ?>
            <input type='hidden' name='name' value="{{$hamburgers->ham_name}}">
            <input type='hidden' name='image' value="{{$hamburgers->ham_image}}">
            <br>
            <img src="{{$hamburgers->ham_image}}" height='250px' width='250px'>
            <br>
            <b><font size='15px'>"{{$hamburgers->ham_name}}"</font></b>
            <br><br>
            <b>Ingredients:     </b>{{$hamburgers->ingredients}}
            <br><br>
            <b>Calories:      </b>{{$hamburgers->calories}} cal
            <br><br>
            <b>Price:     </b>${{$hamburgers->price}}
            <br><br>
            ...
            <br><br>
            <b>Extra Notes:      </b><input style='padding-top: 7px; padding-bottom: 7px; margin-bottom: 15px;' type='text' name='Remarks' placeholder='Remarks'>
            <br><br>
            <input type='submit' value='ordenar ahora' id='order' name='order' class='b3'>
          </form>
          @endforeach
      </center>
    <br><br><br>
    <script type="text/javascript">
        ...
        <?php
          ...
          if($role=="admin")
          {
            ...
            echo 'alert("Admin can not place order");'; 
          ...
          if(!isset($_SESSION['userid']))
          {
            ...
            echo 'window.location.href = "http://localhost:8000/Menu#modal";';
            echo 'event.preventDefault();';
